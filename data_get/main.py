import os
from utils import download, download_file_if_not_exists
...
if __name__ == "__main__":
    ...
    zips_to_download = {
        ...
        "alfabetizacao": "{}/Agregados_por_municipios_alfabetizacao_BR.zip".format(
            base_url_IBGE
        ),
        "basico": "{}/Agregados_por_municipios_basico_BR.zip".format(base_url_IBGE),
        "domicilio1": "{}/Agregados_por_municipios_caracteristicas_domicilio1_BR.zip".format(
            base_url_IBGE
        ),
        "domicilio2": "{}/Agregados_por_municipios_caracteristicas_domicilio2_BR.zip".format(
            base_url_IBGE
        ),
        "domicilio3": "{}/Agregados_por_municipios_caracteristicas_domicilio3_BR.zip".format(
            base_url_IBGE
        ),
        "cor_raca": "{}/Agregados_por_municipios_cor_ou_raca_BR.zip".format(
            base_url_IBGE
        ),
        "demografia": "{}/Agregados_por_municipios_demografia_BR.zip".format(
            base_url_IBGE
        ),
        "domicilio_indigena": "{}/Agregados_por_municipios_domicilios_indigenas_BR.zip".format(
            base_url_IBGE
        ),
        "domicilio_quilombolas": "{}/Agregados_por_municipios_domicilios_quilombolas_BR.zip".format(
            base_url_IBGE
        ),
        "obitos": "{}/Agregados_por_municipios_obitos_BR.zip".format(base_url_IBGE),
        "parentesco": "{}/Agregados_por_municipios_parentesco_BR.zip".format(
            base_url_IBGE
        ),
        "indigenas": "{}/Agregados_por_municipios_pessoas_indigenas_BR.zip".format(
            base_url_IBGE
        ),
